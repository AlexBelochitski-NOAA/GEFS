...
#    git clone --recursive https://github.com/NOAA-EMC/global-workflow.git global-workflow.fd >>  ${logs_dir}/checkout-global-workflow.log 2>&1
    git clone --recursive https://github.com/AlexBelochitski-NOAA/global-workflow.git  global-workflow.fd >>  ${logs_dir}/checkout-global-workflow.log 2>&1
    cd global-workflow.fd
#    git checkout gefs_v12.1.0
    git checkout nnrad_gefs_v12
	cd sorc
    ./checkout.sh
    ERR=$?
